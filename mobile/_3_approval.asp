...
<%		
	...
	params = params & "&approvalUrl=" & "https://상점도메인/mobile/_3_approval.asp"
	params = params & "&closeUrl=" & "https://상점도메인/mobile/_3_close.asp"
	...
	params = params&"&merchantData="&merchantData
...
<script src="https://api-std.mainpay.co.kr/js/mainpay.mobile-1.0.js"></script><!--중복거래방지 함수포함-->
</head>
<body>
<script>
/* 결제 완료 페이지 처리 */
